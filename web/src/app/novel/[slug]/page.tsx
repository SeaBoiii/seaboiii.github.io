  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
        {/* Hero */}
        <section className="grid gap-8 sm:grid-cols-[200px_1fr] lg:grid-cols-[240px_1fr] lg:gap-12">
          ...
          {chapters.length === 0 ? (
            ...
            <ol className="overflow-hidden rounded-2xl border border-border bg-surface shadow-card">
              {chapters.map((c, i) => (
                ...
                >
                  <Link
                    href={`/novel/${novel.slug}/${c.slug}/`}
                    className="flex items-center justify-between gap-4 px-4 py-3.5 transition hover:bg-surface-2 sm:px-5"
                  >
